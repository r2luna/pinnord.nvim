...
local colors = {
	...
	bg4 = "#3e424b", -- editor.lineHighlightBorder
...
-- Diff
hl("DiffAdd", { fg = colors.green, blend = 80 })
hl("DiffChange", { fg = colors.yellow, blend = 80 })
hl("DiffDelete", { fg = colors.red, blend = 80 })
hl("DiffText", { fg = colors.fg2, blend = 60 })
...
-- LSP highlights
hl("LspReferenceText", { bg = colors.bg5, blend = 80 })
hl("LspReferenceRead", { bg = colors.bg5, blend = 80 })
hl("LspReferenceWrite", { bg = colors.bg5, blend = 80 })
